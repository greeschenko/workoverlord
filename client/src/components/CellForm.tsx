...
export default function FormDialog(
    ...
    React.useEffect(() => {
        if (startdata.status == "new") {
            ...
            setStartdata({ ...startdata, ["status"]: "active" });
    ...
    return (
        <>
            <div
                style={{
                    display: pendingSize ? "block" : "none",
                    position: "fixed",
                    border: "3px dashed lightgreen",
                    left: (startdata.position[0] - viewX)/scaleIndex,
                    top: (startdata.position[1] - viewY)/scaleIndex,
                    width: coords.x - (startdata.position[0] - viewX)/scaleIndex,
                    height: coords.y - (startdata.position[1] - viewY)/scaleIndex,
                }}
            ></div>
            <div
                style={{
